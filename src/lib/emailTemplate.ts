                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background-color: #0a1628;">
                    ...
                    <tr>
                        <td style="padding: 32px 40px; text-align: center;">
                            <h1 style="margin: 0 0 8px 0; font-size: 36px; font-weight: 700; color: #c9a84c; letter-spacing: -0.5px;">LuxHunter</h1>
                            <p style="margin: 0; font-size: 14px; color: #9ca3af; letter-spacing: 0.5px;">Premium Property & Mortgage Advisory</p>
                        </td>
                    </tr>
